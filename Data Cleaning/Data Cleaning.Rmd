...
df <- df %>%
  ...
  #LA
  mutate(county_name = replace(county_code,county_code == "06111", "Ventura")) %>%
  mutate(county_name= replace(county_code, county_code == "06059","Orange"))%>%
  mutate(county_name= replace(county_code, county_code == "06071","San Bernardino"))%>%
  mutate(county_name= replace(county_code,county_code == "06037", "Los Angeles"))%>%
