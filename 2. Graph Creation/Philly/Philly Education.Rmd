...
df_philly_2015 %>% 
  ...
  theme_classic() +
  labs(title = "2015 Philadelphia 3rd Grades Reading and Math Scores by County", subtitle = "The red lines show U.S nation's average", x = "County", y = "3rd Grades Reading & Math score")
```
...
ggplot()+
  ...
  labs(
    title="11th and 12th Grade Students in at least one AP course",
