...
## Graphs
```{r}
ggplot(df_philly, aes(x = reorder(county_code, home_ownership), y = median_income)) +
  geom_violin() +
  ...
  geom_hline(yintercept = median(df_philly$median_income), color = "red", linetype = "dashed")+
  theme_bw()+
