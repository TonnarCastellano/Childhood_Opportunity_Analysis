...
grad_rates_good <- grad_rates_nyc %>% 
  filter(county_code %in% c("Manhattan", "Brooklyn",  "Queens", "Bronx"))
grad_rates_bad <-  grad_rates_nyc %>% 
  filter(county_code %in% c("Staten Island"))
```
